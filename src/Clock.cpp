...
void pClock_BRaduiPushCallback(void *ptr)
{
...
void displayTime()
{
    ...
    pClock_THour.setText(String(msg[0]).c_str());
    pClock_Hour.setText(String(msg[1]).c_str());
    pClock_TMin.setText(String(msg[3]).c_str());
    pClock_Min.setText(String(msg[4]).c_str());
    ...
    else
    {
        ...
        {
            pClock_AM.setText(" ");
            pClock_PM.setText("PM");
        }    
        else
        {
            pClock_AM.setText("AM");
            pClock_PM.setText("  ");
        }
    }
}
...
void displayDate()
{
  pClock_Date.setText("%s %s %d, %4d", chDaysOfWeek[tmTime.tm_wday], chMonth[tmTime.tm_mon], tmTime.tm_mday, tmTime.tm_year);
}
...
bool startClock()
{
    ...
    pStartup_Status3.setText("Getting current time");
